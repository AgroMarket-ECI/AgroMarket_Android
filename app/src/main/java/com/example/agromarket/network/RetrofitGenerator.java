package com.example.agromarket.network;


import com.example.agromarket.BuildConfig;
import com.example.agromarket.network.interceptor.AuthInterceptor;
...
public class RetrofitGenerator {
    ...
    static private Retrofit createRetrofitInstance(Storage storage){
        ...
        Retrofit.Builder builder =
                new Retrofit.Builder().baseUrl(BuildConfig.API_BASE_URL).addConverterFactory(
